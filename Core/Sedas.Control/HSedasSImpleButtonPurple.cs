...
{
    public partial class HSedasSImpleButtonPurple : HSimpleButton
    {
        public HSedasSImpleButtonPurple()
        {
            InitializeComponent();
        }

        public HSedasSImpleButtonPurple(IContainer container)
        {
            container.Add(this);
        ...
        public class CustomSkinEditorButtonPainter : SkinEditorButtonPainter
        {
            ...
            {
                return CommonSkins.GetSkin(Provider)["Button_purple"];
            }
        }
