...
{
    public partial class HSedasSImpleButtonBlue : HSimpleButton
    {
        public HSedasSImpleButtonBlue()
        {
        ...
        public HSedasSImpleButtonBlue(IContainer container)
        {
            //Assembly asm = typeof(DevExpress.UserSkins.Seda20200611).Assembly;
            //DevExpress.Skins.SkinManager.Default.RegisterAssembly(asm);
            container.Add(this);
        ...
        public class CustomSkinEditorButtonPainter : SkinEditorButtonPainter
        {
            ...
            {
                return CommonSkins.GetSkin(Provider)["Button_blue"];
            }
        }
