...
{
    public partial class HCheckButton : DevExpress.XtraEditors.CheckButton
    {
        ...
        public HCheckButton(IContainer container)
        {
            container.Add(this);
        ...
        {
            //터치스크린용 큰 이미지 체크박스
            if (this.sedasControlType == ControlType.MaterialControl)
            {
                //this.Size.CheckBoxOptions.Style = DevExpress.XtraEditors.Controls.CheckBoxStyle.SvgCheckBox1;
