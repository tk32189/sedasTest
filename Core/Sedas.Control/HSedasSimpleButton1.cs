...
{
    public partial class HSedasSimpleButton1 : HSimpleButton
    {
        [ToolboxItem(true)]
        public HSedasSimpleButton1() : base()
        {
            InitializeComponent();
        }

        public HSedasSimpleButton1(IContainer container)
        {
            container.Add(this);
        ...
        public class CustomSkinEditorButtonPainter : SkinEditorButtonPainter
        {
            ...
            {
                return CommonSkins.GetSkin(Provider)["Button_1"];
            }
        }
