...
{
    public partial class HSedasSImpleButtonOrange : HSimpleButton
    {
        public HSedasSImpleButtonOrange()
        {
            InitializeComponent();
        }

        public HSedasSImpleButtonOrange(IContainer container)
        {
            container.Add(this);
        ...
        public class CustomSkinEditorButtonPainter : SkinEditorButtonPainter
        {
            ...
            {
                return CommonSkins.GetSkin(Provider)["Button_orage"];
            }
        }
