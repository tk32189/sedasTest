...
{
    public partial class HSedasSimpleButton2 : HSimpleButton
    {
        public HSedasSimpleButton2()
        {
            InitializeComponent();
        }

        public HSedasSimpleButton2(IContainer container)
        {
            container.Add(this);
        ...
        public class CustomSkinEditorButtonPainter : SkinEditorButtonPainter
        {
            ...
            {
                return CommonSkins.GetSkin(Provider)["Button"];
            }
        }
