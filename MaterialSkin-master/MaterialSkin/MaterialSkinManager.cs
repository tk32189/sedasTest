...
namespace MaterialSkin
{
    public class MaterialSkinManager
    {
        ...
        private MaterialSkinManager()
        {
            ...
            ROBOTO_MEDIUM_12 = new Font(LoadFont(Resources.NotoSans_Black), 12f);
            ROBOTO_MEDIUM_10 = new Font(LoadFont(Resources.NotoSans_Medium), 10f);
            ROBOTO_REGULAR_11 = new Font(LoadFont(Resources.NotoSans_Light), 11f);
            ROBOTO_MEDIUM_11 = new Font(LoadFont(Resources.NotoSansKR_Regular), 11f);
            Theme = Themes.LIGHT;
             ...
             */
            //ROBOTO_MEDIUM_12 = new Font(LoadFont(Resources.malgunbd), 12f);
            //ROBOTO_MEDIUM_10 = new Font(LoadFont(Resources.malgunbd), 10f);
            //ROBOTO_REGULAR_11 = new Font(LoadFont(Resources.malgun), 11f);
            //ROBOTO_MEDIUM_11 = new Font(LoadFont(Resources.malgunbd), 11f);

            ROBOTO_MEDIUM_12 = new Font("Noto Sans KR Regular", 12);
            ROBOTO_MEDIUM_10 = new Font("Noto Sans KR Regular", 10);
            ROBOTO_REGULAR_11 = new Font("Noto Sans KR Regular", 11);
            ROBOTO_MEDIUM_11 = new Font("Noto Sans KR Regular", 11);

            //Font("Noto Sans KR Regular", 10)
